    ...
    if (isFeedsLoading) {
        return (
            <main className="min-h-screen pb-16">
                <div className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 space-y-8">
                    {/* Hero Skeleton */}
                    <div className="aspect-[21/9] sm:aspect-[2.4/1] w-full rounded-2xl sm:rounded-3xl bg-zinc-900 animate-pulse" />
                    {/* Rail Skeletons */}
                    {[1, 2, 3].map((i) => (
                            ...
                            <div className="flex gap-4 overflow-hidden">
                                {[1, 2, 3, 4].map((j) => (
                                    <div key={j} className="flex-shrink-0 w-[280px]">
                                        ...
                                        <div className="mt-1 h-3 w-1/2 bg-zinc-900 rounded animate-pulse" />
                                    </div>
                                ))}
                            </div>
                        </div>
