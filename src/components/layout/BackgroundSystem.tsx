    ...
    return (
        <div className="fixed inset-0 z-[-10] pointer-events-none bg-[#050505] overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-[20%] -left-[10%] w-[90%] sm:w-[60%] h-[60%] bg-red-600/15 sm:bg-red-600/10 rounded-full blur-[80px] sm:blur-[100px]" />
                <div className="absolute -bottom-[20%] -right-[10%] w-[90%] sm:w-[60%] h-[60%] bg-yellow-500/15 sm:bg-yellow-500/10 rounded-full blur-[80px] sm:blur-[100px]" />
                <div className="absolute top-[30%] left-[20%] sm:left-[40%] w-[50%] sm:w-[30%] h-[50%] sm:h-[30%] bg-green-500/10 sm:bg-green-500/5 rounded-full blur-[60px] sm:blur-[80px]" />
            </div>
