        ...
        return (
            <main className="min-h-screen pb-16 bg-[#0a0a0a] relative overflow-hidden">
                ...
                <div className="px-4 sm:px-6 lg:px-10 pt-6 sm:pt-8 space-y-12 sm:space-y-16 max-w-[1600px] mx-auto relative z-10">
                    {/* Hero Skeleton */}
                    <div className="relative aspect-[21/9] sm:aspect-[2.4/1] w-full rounded-2xl sm:rounded-3xl bg-white/5 border border-white/10 overflow-hidden shadow-2xl">
                    ...
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="space-y-5">
                            <div className="h-7 w-48 bg-white/5 rounded-lg border border-white/5 relative overflow-hidden">
                                ...
                                {[1, 2, 3, 4, 5].map((j) => (
                                    <div key={j} className="flex-shrink-0 w-[280px] sm:w-[320px]">
                                        ...
                                        <div className="mt-3 flex gap-3">
                                            <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex-shrink-0 relative overflow-hidden">
                                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.02] to-transparent skeleton-shine" />
                                            </div>
                                            <div className="flex-1 space-y-2 py-1">
                                                <div className="h-4 w-full bg-white/5 rounded border border-white/5 relative overflow-hidden" />
                                                <div className="h-3 w-2/3 bg-white/5 rounded border border-white/5 relative overflow-hidden" />
                                            </div>
                                        </div>
                                    </div>
                                ))}
