    ...
    if (!user) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <h1 className="text-2xl font-black text-white uppercase tracking-tighter mb-2">{t("creatorStudio")}</h1>
                <p className="text-gray-400 mb-8 max-w-md">{t("signInPrompt")}</p>
                <Link
                    href="/?login=true"
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="bg-white/[0.03] text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] border-b border-white/5">
                                <tr>
                                    <th className="px-8 py-5">{t("video")}</th>
                                    <th className="px-8 py-5">{t("visibility")}</th>
                                ...
                                {userVideos.map((video) => (
                                    <tr key={video.id} className="hover:bg-white/[0.02] transition-colors group">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-5">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <p className="text-[10px] text-gray-500 font-mono mt-1 opacity-60 uppercase">{t("categoryLabel")}{video.category}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6">
                                            ...
                                            <p className="text-[10px] text-gray-600 uppercase font-black mt-0.5 tracking-tighter">{t("published")}</p>
                                        </td>
                                        <td className="px-8 py-6">
