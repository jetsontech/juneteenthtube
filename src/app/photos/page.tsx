...
export default function PhotosPage() {
    ...
    // Filter photos dynamically based on selected state (Global includes everything)
    const filteredPhotos = useMemo(() => {
        if (!selectedState || selectedState.code === "GLOBAL") return photos;
        return photos.filter((p) => p.state === selectedState.code || p.state === "GLOBAL");
    }, [photos, selectedState]);
        ...
        <div className="min-h-screen px-4 sm:px-6 lg:px-8 py-6">
            ...
            {selectedIndex !== null && filteredPhotos[selectedIndex] && (
                ...
                >
                    ...
                    >
                        {filteredPhotos[selectedIndex].photo_url ? (
                            <Image
                                src={filteredPhotos[selectedIndex].photo_url}
                        ...
                        <p className="text-white text-lg mt-4 font-medium">
                            {filteredPhotos[selectedIndex].caption || filteredPhotos[selectedIndex].title}
                        </p>
